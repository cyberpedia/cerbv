...
/**
 * Dropdown Menu component following Technical Brutalism design system
 * Uses Radix UI Dropdown Menu primitive
 * WCAG 2.1 AAA compliant with keyboard navigation and focus management
 */
...
>(({ className, children, ...props }, ref) => (
  ...
  >
    <span className="absolute left-2 flex h-3.5 w-3.5 items-center justify-center">
      <DropdownMenuPrimitive.ItemIndicator>
        <Circle className="h-2 w-2 fill-safety text-safety" />
      </DropdownMenuPrimitive.ItemIndicator>
    </span>
    {children}
  </DropdownMenuPrimitive.RadioItem>
